...
public class HICFragmentNavigator {
    ...
    private HICFragmentNavigator(final FragmentActivity activity, int fragmentContainerId) {
        this.fragmentContainerId = fragmentContainerId;
        this.fragmentManager = activity.getSupportFragmentManager();
    }

    public static HICFragmentNavigator create(FragmentActivity activity, int fragmentContainerId) {
        return new HICFragmentNavigator(activity, fragmentContainerId);
    }
