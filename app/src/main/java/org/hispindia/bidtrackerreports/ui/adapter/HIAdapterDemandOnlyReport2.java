 ...
 */
public class HIAdapterDemandOnlyReport2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterDemandOnlyReport2.class.getSimpleName();
    ...
    public HIAdapterDemandOnlyReport2() {
