 ...
 */
public class HIAdapterStockDemandReport2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterStockDemandReport2.class.getSimpleName();
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_PROGRESS = 1;
    private static final int TYPE_HEADER = 2;
    public List<String> hiStockRowList2;
    ...
    public HIAdapterStockDemandReport2() {
        hiStockRowList2 = new ArrayList<>();
        inhand = new HashMap<>();
        demand = new HashMap<>();
        difference = new HashMap<>();

        hiStockRowList2.add("RV");
        hiStockRowList2.add("PCV");
        hiStockRowList2.add("Measles");
        hiStockRowList2.add("DPT");
        hiStockRowList2.add("BCG");
        hiStockRowList2.add("OPV");
        // hiStockRowList.add("Total");
        loadDone = false;
    }


    public void setInHandList2(List<HIStockRow2> inHandList) {
        for (HIStockRow2 item : inHandList) {
    ...
    public void setDemandList(List<HIDBbidrow> demandList) {
        for (String key : hiStockRowList2) {
            demand.put(key, 0);
        }
