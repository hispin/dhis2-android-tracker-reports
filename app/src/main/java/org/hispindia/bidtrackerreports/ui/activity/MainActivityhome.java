...
/**
 * Created by Sourabh on 5/27/2016.
 */
public class MainActivityhome extends AbsHomeActivity implements INavigationHandler {
...
//                getString(R.string.drawer_item_profile));
    ...
    protected boolean onItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == 11) {
            attachFragment(WrapperFragment.newInstance(HIFragmentMain.class, getString(R.string.app_name)));
            return true;
        }
        return false;
    }
    ...
    public void loadInitialData() {
        ...
        DhisService.loadInitialData(MainActivityhome.this);
    }
