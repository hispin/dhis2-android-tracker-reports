 ...
 */
public class HIAdapterStockReport3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static String TAG = HIAdapterStockReport3.class.getSimpleName();
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_PROGRESS = 1;
    private static final int TYPE_HEADER = 2;

    private boolean loadDone;
    private List<HIStockRow3> hiStockRowList3;


    public HIAdapterStockReport3() {
    ...
    public void setHiStockRowList3(List<HIStockRow3> hiStockRowList3) {
        this.hiStockRowList3 = hiStockRowList3;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HIAdapterStockHeaderHolder) {
            ...
            HIStockRow3 currentItem = getItem(position - 1);
    ...
    private HIStockRow3 getItem(int position) {
