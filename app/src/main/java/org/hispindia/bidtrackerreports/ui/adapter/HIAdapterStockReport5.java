 ...
 */
public class HIAdapterStockReport5 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static String TAG = HIAdapterStockReport5.class.getSimpleName();
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_PROGRESS = 1;
    private static final int TYPE_HEADER = 2;

    private boolean loadDone;
    private List<HIStockRow5> hiStockRowList5;


    public HIAdapterStockReport5() {
        hiStockRowList5 = new ArrayList<>();
        loadDone = false;
    }



    public void setHiStockRowList5(List<HIStockRow5> hiStockRowList5) {
        this.hiStockRowList5 = hiStockRowList5;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HIAdapterStockHeaderHolder) {
            ...
            HIStockRow5 currentItem = getItem(position - 1);
    ...
    public int getItemCount() {
        return hiStockRowList5.size() + 2;
    }

    private HIStockRow5 getItem(int position) {
        return hiStockRowList5.get(position);
    }
    ...
    private boolean isPositionFooter(int position) {
        return position == hiStockRowList5.size() + 1;
    }
