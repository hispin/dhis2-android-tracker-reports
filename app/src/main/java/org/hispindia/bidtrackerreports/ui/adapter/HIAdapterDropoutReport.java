 ...
 */
public class HIAdapterDropoutReport extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public final static String TAG = HIAdapterDropoutReport.class.getSimpleName();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_PROGRESS) {
            ...
            return new HIAdapterDropoutFooterHolder(v, parent.getContext());
        } else if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.hiviewitem_dropout_row, parent, false);
            return new HIAdapterDropoutFooterHolder(v, parent.getContext());
        }
        return null;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HIAdapterDropoutFooterHolder) {
            HIAdapterDropoutFooterHolder viewHolder = (HIAdapterDropoutFooterHolder) holder;
            if (!loadDone) viewHolder.vProgressBar.setVisibility(View.VISIBLE);
            else viewHolder.vProgressBar.setVisibility(View.GONE);
        } else if (holder instanceof HIAdapterDropoutReportHolder) {
            HIDBbidrow row = getItem(position);
            HIAdapterDropoutReportHolder viewHolder = (HIAdapterDropoutReportHolder) holder;
    ...
    class HIAdapterDropoutReportHolder extends RecyclerView.ViewHolder {
...
//        SearchView searchView;
        ...
        @Bind(R.id.tvmothercarenumber)
        TextView tvmothercarenumber;

        @Bind(R.id.tvbcgdropout)
        TextView tvbcgdropout;
        @Bind(R.id.tvdptdropout)
        TextView tvdptdropout;

        @Bind(R.id.tvfollowupassign)
        TextView tvfollowupassign;
        ...
        public HIAdapterDropoutReportHolder (View itemView, Context context) {
            super(itemView);
    ...
    class HIAdapterDropoutFooterHolder extends RecyclerView.ViewHolder {

        @Bind(R.id.vProgressBar)
        ProgressBar vProgressBar;
        Context context;

        public HIAdapterDropoutFooterHolder(View itemView, Context context) {
            super(itemView);
            this.context = context;
            ButterKnife.bind(this, itemView);
        }
