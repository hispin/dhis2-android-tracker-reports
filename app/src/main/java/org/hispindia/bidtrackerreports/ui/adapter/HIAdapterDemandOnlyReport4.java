 ...
 */
public class HIAdapterDemandOnlyReport4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterDemandOnlyReport4.class.getSimpleName();
    ...
    public HIAdapterDemandOnlyReport4() {
