 ...
 */
public class HIFragmentMain1 extends AbsHomeActivity implements INavigationHandler {

    public final static String TAG = HIFragmentMain1.class.getSimpleName();
...
//                getString(R.string.drawer_item_profile));
    ...
    protected boolean onItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == 11) {
            attachFragment(WrapperFragment.newInstance(org.hisp.dhis.android.sdk.ui.fragments.selectprogram.SelectProgramFragment.class, getString(R.string.app_name)));
            return true;
        }
        return false;
    }
    ...
    public void loadInitialData() {
        ...
        DhisService.loadInitialData(HIFragmentMain1.this);
    }
