 ...
 */
public class HIAdapterStockDemandReport1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterStockDemandReport1.class.getSimpleName();
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_PROGRESS = 1;
    private static final int TYPE_HEADER = 2;
    public List<String> hiStockRowList1;
    ...
    public HIAdapterStockDemandReport1() {
        hiStockRowList1 = new ArrayList<>();
        inhand = new HashMap<>();
        demand = new HashMap<>();
        difference = new HashMap<>();

        hiStockRowList1.add("RV");
        hiStockRowList1.add("PCV");
        hiStockRowList1.add("Measles");
        hiStockRowList1.add("DPT");
        hiStockRowList1.add("BCG");
        hiStockRowList1.add("OPV");
        // hiStockRowList.add("Total");
        loadDone = false;
    }


    public void setInHandList1(List<HIStockRow1> inHandList) {
        for (HIStockRow1 item : inHandList) {
    ...
    public void setDemandList(List<HIDBbidrow> demandList) {
        for (String key : hiStockRowList1) {
            demand.put(key, 0);
        }
