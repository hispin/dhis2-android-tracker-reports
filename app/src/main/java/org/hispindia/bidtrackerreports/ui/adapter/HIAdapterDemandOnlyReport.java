 ...
 */
public class HIAdapterDemandOnlyReport extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterDemandOnlyReport.class.getSimpleName();
    ...
    public HIAdapterDemandOnlyReport() {
