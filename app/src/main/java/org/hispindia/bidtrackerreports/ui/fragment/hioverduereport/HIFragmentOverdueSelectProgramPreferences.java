 ...
 */
public class HIFragmentOverdueSelectProgramPreferences {
    private static final String PROGRAM_FRAGMENT_PREFERENCES = "preferences:HIFragmentOverdueSelectProgramPreferences";
    ...
    public HIFragmentOverdueSelectProgramPreferences(Context context) {
