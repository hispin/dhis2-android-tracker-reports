 ...
 */
public class HIAdapterDemandOnlyReport1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterDemandOnlyReport1.class.getSimpleName();
    ...
    public HIAdapterDemandOnlyReport1() {
