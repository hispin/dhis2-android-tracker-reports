 ...
 */
public class HIAdapterStockDemandReport4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int abc = 0;
    public final static String TAG = HIAdapterStockDemandReport4.class.getSimpleName();
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_PROGRESS = 1;
    private static final int TYPE_HEADER = 2;
    public List<String> hiStockRowList4;
    ...
    public HIAdapterStockDemandReport4() {
        hiStockRowList4 = new ArrayList<>();
        inhand = new HashMap<>();
        demand = new HashMap<>();
        difference = new HashMap<>();

        hiStockRowList4.add("RV");
        hiStockRowList4.add("PCV");
        hiStockRowList4.add("Measles");
        hiStockRowList4.add("DPT");
        hiStockRowList4.add("BCG");
        hiStockRowList4.add("OPV");
    ...
    public void setDemandList(List<HIDBbidrow> demandList) {
        for (String key : hiStockRowList4) {
            demand.put(key, 0);
        }
