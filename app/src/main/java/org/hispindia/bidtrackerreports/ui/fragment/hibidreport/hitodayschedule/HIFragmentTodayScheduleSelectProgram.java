 ...
 */
public class HIFragmentTodayScheduleSelectProgram extends HICFragmentBase implements View.OnClickListener, AutoCompleteDialogFragment.OnOptionSelectedListener,
        SwipeRefreshLayout.OnRefreshListener,
        MenuItemCompat.OnActionExpandListener {
    public final static String TAG = HIFragmentTodayScheduleSelectProgram.class.getSimpleName();
    protected final String STATE;

    protected HIFragmentTodayScheduleSelectProgramState mState;
    protected HIFragmentTodayScheduleSelectProgramPreferences mPrefs;
    ...
    public HIFragmentTodayScheduleSelectProgram() {
        this("state:HIFragmentSelectProgram");
    }

    @SuppressLint("ValidFragment")
    private HIFragmentTodayScheduleSelectProgram(String stateName) {
        STATE = stateName;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.hifragment_todayschedule_select_program, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mPrefs = new HIFragmentTodayScheduleSelectProgramPreferences(
        ...
        if (mState == null) {
            ...
            mState = new HIFragmentTodayScheduleSelectProgramState();
            if (orgUnit != null) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnGenerateReport:
                ...
                //mNavigationHandler.switchFragment(HIFragmentTodayScheduleReport.newInstance(mState.getOrgUnitId(),mState.getOrgUnitModeId(),mState.getProgramId(),mState.getFromDay(),mState.getToDay()) ,HIFragmentTodayScheduleReport.TAG, true);
                break;
        }
    }
    ...
    public void onRestoreState(boolean hasUnits) {
        ...
        HIFragmentTodayScheduleSelectProgramState backedUpState = new HIFragmentTodayScheduleSelectProgramState(mState);
