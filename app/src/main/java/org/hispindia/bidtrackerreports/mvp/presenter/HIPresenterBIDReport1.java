 ...
 */
public class HIPresenterBIDReport1 implements HIIPresenterBase<HIIViewBIDReport> {
    public final static String TAG = HIPresenterBIDReport1.class.getSimpleName();

    private final HIBIDModel model;
    private Subscription subscription;
    private Subscription subscriptionUpdated;

    public HIPresenterBIDReport1(HIBIDModel model) {
        this.model = model;
    }
