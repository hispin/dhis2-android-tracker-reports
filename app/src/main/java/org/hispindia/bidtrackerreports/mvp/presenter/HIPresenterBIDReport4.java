 ...
 */
public class HIPresenterBIDReport4 implements HIIPresenterBase<HIIViewBIDReport> {
    public final static String TAG = HIPresenterBIDReport4.class.getSimpleName();

    private final HIBIDModel model;
    private Subscription subscription;
    private Subscription subscriptionUpdated;

    public HIPresenterBIDReport4(HIBIDModel model) {
        this.model = model;
    }
