 ...
 */
public class HIPresenterBIDReport3 implements HIIPresenterBase<HIIViewBIDReport> {
    public final static String TAG = HIPresenterBIDReport3.class.getSimpleName();

    private final HIBIDModel model;
    private Subscription subscription;
    private Subscription subscriptionUpdated;

    public HIPresenterBIDReport3(HIBIDModel model) {
        this.model = model;
    }
