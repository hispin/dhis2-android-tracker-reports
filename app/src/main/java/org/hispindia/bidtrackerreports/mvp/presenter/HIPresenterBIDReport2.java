 ...
 */
public class HIPresenterBIDReport2 implements HIIPresenterBase<HIIViewBIDReport> {
    public final static String TAG = HIPresenterBIDReport2.class.getSimpleName();

    private final HIBIDModel model;
    private Subscription subscription;
    private Subscription subscriptionUpdated;

    public HIPresenterBIDReport2(HIBIDModel model) {
        this.model = model;
    }
